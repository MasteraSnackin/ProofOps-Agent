...
| Superlinked | Side Challenge, used directly in retrieval | Reranks proof candidates semantically against the stalled deal. Local matching creates a deterministic baseline, then Superlinked improves relevance using sector, segment, objections, products, consent and outcome signals. ALSO USED IT TO CREATE THE DEMO VIDEO
